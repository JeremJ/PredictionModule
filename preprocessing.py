...
import pydicom
dicom_root = '/Users/jeremiaszjaworski/PycharmProjects/PredictionModule/zdrowe/'
...
for patient_no in sorted(patients):
    ...
    # plt.show()
    resized = cv2.resize(img, (IMG_PX_SIZE, IMG_PX_SIZE))
    plt.imsave('/Users/jeremiaszjaworski/PycharmProjects/PredictionModule/zdrowe-png-test/' + patient_no.replace('.dcm', '.png'), resized, cmap='gray')
